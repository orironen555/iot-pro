...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn_2=QPushButton("", self)
        self.ePushtbtn_2.setToolTip("Push me")
        self.ePushtbtn_2.setStyleSheet("background-color: green")
        ...
        formLayot.addRow("taffic lights n-s",self.ePushtbtn)
        formLayot.addRow("taffic lights e-w",self.ePushtbtn_2)
    ...
    def on_connected(self):
        self.eConnectbtn.setStyleSheet("background-color: blue")
    ...
    def update_btn_state(self,text):
        ...
        if ON:
            ...
            self.ePushtbtn_2.setStyleSheet("background-color: red")
            ON = True   
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('traffic lightes')        
