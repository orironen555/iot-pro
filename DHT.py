...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("warning",self.warning)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # set up main window
        self.setGeometry(30, 60, 300, 150)
    ...
    def update_data(self):
        ...
        if temp<8 :
            Warning = 'warning low temp'
            self.connectionDock.warning.setText('warning low temp')
            self.mc.publish_to(DHT_topic,Warning)
        elif temp>35:
            Warning = 'warning high temp'
            self.connectionDock.warning.setText('warning high temp')
            self.mc.publish_to(DHT_topic,Warning)
        else:
            self.connectionDock.warning.setText('drive safe')
