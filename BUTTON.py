...
class Mqtt_client():
    ...
    def connect_to(self):
        ...
        self.client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION1, "IOT_pudfdzfb_ugfefweu_jdksf")
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn=QPushButton("south->north", self)
        self.ePushtbtn.setToolTip("Push me")
        self.ePushtbtn.clicked.connect(lambda: self.push_button_click('ePushtbtn'))
        self.ePushtbtn.setStyleSheet("background-color: red")

        self.ePushtbtn02=QPushButton("north->south", self)
        self.ePushtbtn02.setToolTip("Push me")
        self.ePushtbtn02.clicked.connect(lambda: self.push_button_click('ePushtbtn02'))
        self.ePushtbtn02.setStyleSheet("background-color: blue")


        self.ePushtbtn03=QPushButton("east->west", self)
        self.ePushtbtn03.setToolTip("Push me")
        self.ePushtbtn03.clicked.connect(lambda: self.push_button_click('ePushtbtn03'))
        self.ePushtbtn03.setStyleSheet("background-color: yellow")

        
        self.ePushtbtn04=QPushButton("west->east", self)
        self.ePushtbtn04.setToolTip("Push me")
        self.ePushtbtn04.clicked.connect(lambda: self.push_button_click('ePushtbtn04'))
        self.ePushtbtn04.setStyleSheet("background-color: pink")
        ...
        formLayot.addRow("direction",self.ePushtbtn)
        formLayot.addRow("direction",self.ePushtbtn02)
        formLayot.addRow("direction",self.ePushtbtn03)
        formLayot.addRow("direction",self.ePushtbtn04)
    ...
    def push_button_click(self,button_id):
        value_mapping ={
           'ePushtbtn' : "south->north",
           'ePushtbtn02' : "north->south",
           'ePushtbtn03' :"east->west",
           'ePushtbtn04':"west->east",
        }
        value = value_mapping.get(button_id,0)
        message = '{{"direction":{}}}'.format(value)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Terrific - Traffic app')        
